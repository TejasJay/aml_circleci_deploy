...
class dBOperation_prediction:
    ...
    def cassandra_connection(self):
        ...
        self.logging.log(self.log_file, 'Entered the cassandra_connection method of dBOperation_prediction class')
        self.log_file.close()
        try:
            ...
            self.logging.log(self.log_file,
                             'Unsuccessful in executing cassandra_connection method of the dBOperation_prediction class: error message is: ' + str(
                                 e))
            self.log_file.close()
    ...
    def isconnectionestablished(self):
        ...
        """
        self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
        self.logging.log(self.log_file, 'Entered the isconnectionestablished method of dBOperation_prediction class')
        self.log_file.close()
        ...
        try:
            ...
            self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
            self.logging.log(self.log_file,
                             'Unsuccessful in executing isconnectionestablished method of the dBOperation_prediction class: error message is: ' + str(
                                 e))
            self.log_file.close()
    ...
    def get_key_space(self):
        ...
        """
        self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
        self.logging.log(self.log_file, 'Entered the get_key_space method of dBOperation_prediction class')
        self.log_file.close()
        ...
        try:
            ...
            self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
            self.logging.log(self.log_file,
                             'Unsuccessful in executing get_key_space method of the dBOperation_prediction class: error message is: ' + str(
                                 e))
            self.log_file.close()
    ...
    def create_table(self):
        ...
        """
        self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
        self.logging.log(self.log_file, 'Entered the create_table method of dBOperation_prediction class')
        self.log_file.close()

        try:
            session = self.cassandra_connection()
            row = session.execute(
                "CREATE TABLE IF NOT EXISTS {}.{table}(unique_ID UUID PRIMARY KEY, Transacted_amount float , Orig_OLD_acc_balance float, Orig_NEW_acc_balance float, Dest_OLD_acc_balance float,Dest_NEW_acc_balance float, latitude float, longitude float, total_hrs_from_first_trans float, transaction_type int);".format(
                    self.key_space, table=self.table_name)).one()
            return row
        except Exception as e:
            self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
            self.logging.log(self.log_file,
                             'In exception block of create_table method of dBOperation_prediction class: error message: ' + str(e))
            self.log_file.close()
    ...
    def insertIntoTableGoodData(self):
        ...
        """
        self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
        self.logging.log(self.log_file, 'Entered the insertIntoTableGoodData method of dBOperation_prediction class')
        self.log_file.close()
                ...
                with open(goodFilePath + '/' + file, "r") as f:
                    ...
                    for line in enumerate(reader):
                        for list_ in (line[1]):
                            try:
                                session.execute(
                                    "insert into {}.{table} (unique_ID,Transacted_amount,Orig_OLD_acc_balance,Orig_NEW_acc_balance,Dest_OLD_acc_balance,Dest_NEW_acc_balance,latitude,longitude,total_hrs_from_first_trans,transaction_type) values({values});".format(
    ...
    def selectingDatafromtableintocsv(self):
        ...
        """
        self.log_file = open("Prediction_Logs/Prediction_Log.txt", 'a+')
        self.logging.log(self.log_file, 'Entered the selectingDatafromtableintocsv method of dBOperation_prediction class')
        self.log_file.close()
    ...
    def deleteRecords(self):
        ...
        self.logging.log(self.log_file,'Entered the deleteRecords method of dBOperation_prediction class')
        self.log_file.close()
        ...
        try:
            ...
            self.log_file = open("Training_Logs/Training_Main_Log.txt", 'a+')
            self.logging.log(self.log_file,'Unsuccessful in executing deleteRecords method of the dBOperation_prediction class: error message is: ' + str(e))
            self.log_file.close()
